	...
	switch(action)
		...
		if("manifest")
			...
			for(var/datum/data/record/t in SSdatacore.get_records(DATACORE_RECORDS_STATION))
				dat += "<tr><td>[t.fields[DATACORE_NAME]]</td><td>[t.fields[DATACORE_TITLE]][t.fields[DATACORE_TITLE] != t.fields[DATACORE_TEMPLATE_RANK] ? " ([t.fields[DATACORE_TEMPLATE_RANK]])" : ""]</td></tr>"
			dat += "</table>"
